...
BiteBuddy is a mobile app operated by Connor Larson (sole proprietor), doing business as BiteBuddy ("BiteBuddy," "we," "us"). By creating an account or using BiteBuddy, you agree to these Terms of Service and to the Privacy Policy. If you do not agree, do not use BiteBuddy.

## 2. Eligibility and minimum age

You must be at least 16 years old to use BiteBuddy. By creating an account you confirm that you are 16 or older. BiteBuddy is not directed to children, and we do not knowingly collect personal information from anyone under 16. If we learn that an account belongs to someone under 16, we may suspend or delete it.
...
You agree not to: misuse, probe, or disrupt the service or its security features; attempt to access other users' data; reverse engineer the app except where the law permits; use automated scripts to consume scan quota; or use BiteBuddy for any unlawful purpose. We may throttle, suspend, or terminate accounts that violate these Terms.

## 8. Subscriptions and billing

BiteBuddy offers optional auto-renewing subscriptions ("BiteBuddy Pro") purchased through Apple. Pricing, renewal, cancellation, and refunds are governed by the Subscription Terms and Apple's App Store rules. Free accounts have usage limits (for example, a limited number of AI scans per week) that we may adjust over time.

## 9. Cancellation and account deletion

You can stop using BiteBuddy at any time. You can delete your account from Profile → Delete Account, which permanently deletes your account and associated data as described in the Privacy Policy. Deleting the app does not cancel a subscription — manage subscriptions in your Apple ID settings.

## 10. Intellectual property

BiteBuddy, including its mascot, design, software, and content (excluding your content), is owned by us or our licensors and is protected by law. We grant you a personal, non-exclusive, non-transferable, revocable license to use the app for personal, non-commercial purposes.
...
You will indemnify and hold us harmless from claims arising out of your misuse of the service or violation of these Terms, to the extent permitted by law.

## 15. Termination

We may suspend or terminate access for violations of these Terms, legal requirements, or discontinuation of the service. Sections that by their nature should survive termination (including 5, 12, 13, 14) survive.

## 16. Changes to these Terms

We may update these Terms. If we make material changes, we will present the new version in the app and require re-acceptance before continued use. The version identifier at the top of this document changes with each revision.
